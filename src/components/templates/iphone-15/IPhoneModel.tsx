...
/** Material names that should NOT have their color changed */
const LOCKED_MATERIALS = new Set([
  "zFdeDaGNRwzccye",
  "ujsvqBWRMnqdwPx",
  "hUlRcbieVuIiOXG",
  "jlzuBkUzuJqgiAK",
...
interface IPhoneModelItem {
  color: string[];
  img: string;
}

interface IPhoneModelProps {
  item: IPhoneModelItem;
